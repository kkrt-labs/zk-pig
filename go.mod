...
require (
	...
	github.com/kkrt-labs/go-utils v0.2.4-0.20250310153000-5da3bd5f9e73
...
replace github.com/ethereum/go-ethereum => github.com/kkrt-labs/go-ethereum v0.9.40-0.20250317123911-c10ff7457bcb
