...
import (
	...
	ethproofs "github.com/kkrt-labs/kakarot-controller/src/ethproofs"
)
...
func (mr *MockClientMockRecorder) CreateCluster(ctx, req interface{}) *gomock.Call {
...
func (mr *MockClientMockRecorder) CreateMachine(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) ListAWSPricing(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) ListClusters(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) QueueProof(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) StartProving(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) SubmitProof(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
